...
public class mod7sc extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://signon.service-now.com/x_snc_sso_auth.do#/sign-up");
        ...
        try
        {
            actions.EnterData(new html(driver).fname,"lohith");
        ...
        try
        {
            actions.EnterData(new html(driver).lname,"kumar");
