...
public class mod7scc extends  AllActions {
...
String test1="ohi";
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new html(driver).fname,actions.getData("./Excel/Book1.xlsx","Sheet1",2,0));
        ...
        try
        {
            actions.EnterData(new html(driver).lname,actions.getData("./Excel/Book1.xlsx","Sheet1",3,0));
        ...
        try
        {
            actions.Click(new html(driver).signup);
        ...
        try
        {
            test1=actions.GetAttribute(new html(driver).fname,"rakesh");
